...
app.use(fileUpload());
app.use(logFunction)
app.post('/add_new_equipment', service.check_new_equipment, service.upsert_equipment)
...
app.post('/upload_new_video', service.uploadHandler, service.matching_new_upload)
...
app.post('/upload_video_multi', service.upload_video_multi, service.upload_result)
