        ...
        <div class="the-navbar__user-meta flex items-center">
          ...
          >
            <div class="con-img ml-3">
              <img
                v-if="activeUserImg ? activeUserImg.startsWith('http') : false"
                key="onlineImg"
                :src="activeUserImg"
                alt="user-img"
                width="40"
              ...
              <img
                v-else
                key="localImg"
                :src="require(`@/assets/images/profile/coke.jpg`)"
                alt="user-img"
                width="40"
                height="40"
                class="rounded-full shadow-md cursor-pointer block"
...
export default {
  ...
  computed: {
    ...
    getCurrentLocaleData() {
      ...
      else if (locale == "th") return { flag: "th", lang: "ไทย" };
    },
  },
  methods: {
    updateLocale(locale) {
